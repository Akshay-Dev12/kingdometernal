(function() {
  ...
  MESSAGES.push({
    delay: 0,
    text: "Kingdom eternal global ministries is an non-profit organization of christians who are united in christ and zealous of taking Lord's good news of salvation to everyone around the world. "
  });

  MESSAGES.push({
    delay: 1200,
    text: "Jesus said , 'You shall know the truth , and the truth shall make you free.'John 8:32."
  });

  MESSAGES.push({
    delay: 2200,
    text: "So it is a trumpet call to"
  });

  MESSAGES.push({
    delay: 3600,
    text:  "-    Arise to inherit the eternal kingdom .<br>-    Arise to minister for eternal kingdom.</br>"
  });
